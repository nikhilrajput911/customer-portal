...
//                    table2.draw();
                    var fromDate = $("#from_report2").val();
                    var toDate = $("#to_report2").val();

                    if (fromDate === "")
                    {
                        $("#from_report2").css("border-color", "red");
                        return false;
                    }
                    else
                    {
                        $("#from_report2").css("border-color", "");
                    }
                    if (toDate === "")
                    {
                        $("#to_report2").css("border-color", "red");
                        return false;
                    }
                    else
                    {
                        $("#to_report2").css("border-color", "");
                    }
...
//                        alert(obj.status);
                                    ...
                                    {
                                        row += "<tr><td>" + (i + 1) + "</td><td>" + obj.Result[i].FieldName + "</td><td>" + obj.Result[i].OldValue + "</td><td>" + obj.Result[i].NewValue + "</td><td>" + obj.Result[i].ActionDate + "</td><td>" + obj.Result[i].Username + "</td><td>" + obj.Result[i].PersonalName + "</td><td>" + obj.Result[i].Customer + "</td></tr>";
                                    }



//                                    $("#Search_document_table_div").css("display", "block");
                                    $("#download_document_report2_table").children("tbody").html(row);


                                    if ($.fn.DataTable.isDataTable('#download_document_report2_table')) {
//                                        alert("if");
                                        ...
                                        if (row_count > 0)
                                        {
                                            table2 = $('#download_document_report2_table').dataTable({
                                                dom: 'Bfrtip',
                                                buttons: [
                                                    'excel', 'print'
                                                ],
...
//                                        alert("else");
                ...
                $("#from_report2").datepicker({
                    dateFormat: 'dd-mm-yy',
                    onSelect: function(dateText, inst) {
                        $("#to_report2").datepicker("option", "minDate", $("#from_report2").datepicker("getDate"));
                    }
                });

                $("#to_report2").datepicker({dateFormat: 'dd-mm-yy'});
            });
    ...
    <body>
        ...
        <div class="page-content">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a data-toggle="pill" href="#custprofileupdatereport">Customer Profile Update Report</a></li>
            ...
            <div class="tab-content">
                ...
                <div id="custprofileupdatereport" class="tab-pane fade in active">
                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="">
                                        <input type="text" placeholder="DD-MM-YYYY" id="from_report2" name="from_report2" class="span10 search-doc-form-field" style="background-color: white !important;">
                        ...
                        <div class="span6">
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="">
                                        <input type="text" placeholder="DD-MM-YYYY" id="to_report2" name="to_report2" class="span10 search-doc-form-field" style="background-color: white !important;">
                                        <div id='error' style='color:red;'></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row-fluid">
                        <div class="span12 table-responsive">
                            <table style="width: 100%;" id="download_document_report2_table" class="table table-striped table-bordered table-hover">
                                <thead>
                                <th>S.No.</th>
