...
//                console.log(pending);
    ...
    <body>
                ...
                <div class="span2">
                    <div class="card hoverCSS">
                        <div class="card-body bg-primary text-white">
                            ...
                            <p class="card-text align-center"><h2>${detailsMap.totalSelection}</h2></p>
                ...
                <div class="span2">
                    <div class="card hoverCSS">
                        <div class="card-body bg-warning text-white">
                            ...
                            <p class="card-text"><h2>${detailsMap.pendingSelection}</h2></p>
                            <a href="#" class="card-link text-white">Details</a>
                            <!--<a href="#" class="card-link text-white">Another link</a>-->
                        </div>
                    </div>
                ...
                <div class="span3">
                    <div class="card hoverCSS">
                        <div class="card-body bg-danger text-white">
                            <h4 class="card-title">Bid Submitted RFP</h4>
                            <p class="card-text"><h2>${detailsMap.awaitingAwardSelection}</h2></p>
                            <a href="#" class="card-link text-white">Details</a>
                            <!--<a href="#" class="card-link text-white">Another link</a>-->
                        </div>
                    </div>
                ...
                <div class="span2">
                    <div class="card hoverCSS">
                        <div class="card-body bg-success text-white">
                            <h4 class="card-title">Rejected RFP</h4>
                            <p class="card-text"><h2>${detailsMap.rejectedSelection}</h2></p>
                            <a href="#" class="card-link text-white">Details</a>
                            <!--<a href="#" class="card-link text-white">Another link</a>-->
                        </div>
                    </div>
                ...
                <div class="span2">
                    <div class="card hoverCSS">
                        <div class="card-body bg-dark text-white">
                            ...
                            <p class="card-text"><h2>${detailsMap.awardedSelection}</h2></p>
                            <a href="#" class="card-link text-white">Details</a>
                            <!--<a href="#" class="card-link text-white">Another link</a>-->
                        </div>
                    </div>
                            ...
                            <div class="widget-main no-padding">
                                <div class="dialogs">													
                                    <table id="rfpTableId" class="table table-bordered table-responsive table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach var="supplierSelection" items="${detailsMap.headers}" varStatus="status">
                                                <tr>
                                                    <td>${status.count}</td>
                                                    <td><a href="redirectByRfpStatus.do?rfpid=${supplierSelection.BPaasWorkOrderRFQHeaderRFQID.rfqid}&status=${supplierSelection.supplierWFstatus}">RFP_${supplierSelection.BPaasWorkOrderRFQHeaderRFQID.rfqid}</a></td>
        ...
        <input type="hidden" id="totalRFP" value="${detailsMap.TotalRfq}">
