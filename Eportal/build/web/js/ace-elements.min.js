...
//            alert(i);
            ...
            i.$nextBtn = g.find(".btn-next").eq(0).on(ace.click_event, function() {
                var isValid = true;
                var status = "";
                //alert(h.find("li").find("span").text());
                $(".form-field").each(function() {
                    status = $("#rfqstatus").val();
                    if ($(this).val().trim() === '' || $(this).val() === 'Select') {
                        //alert($(this).parent().parent().siblings("label").text() + " is blank!");
...
//                alert($("#check_constraint").val() + " : " + isValid);
//                alert(status);
                if((isValid === true && $("#check_constraint").val() === 'true') || (status !== "Open"))
                {
                    h.wizard("next");
                }
                else
