                        ...
                        <div class="widget-main">
                            <div class="row-fluid">
                                ...
                                <div class="step-content row-fluid position-relative" id="step-container">
                                    <form class="form-vertical" id="validation-emp" method="post" action="updateForRevision.do" enctype="multipart/form-data">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <div class="">
                                                                <input type="text" value="${rfqDetails.supplierSelection.get(0).supplierWFstatus}" id="rfqstatus" name="rfqstatus" class="span10 form-field" required readonly/>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <table id="cat_subcat_table" name="cat_subcat_table" class="table table-striped table-bordered table-hover">
                                                        ...
                                                        <tbody>
                                                            <c:forEach var="lineItem" items="${rfqDetails.rfqLineItems}">
                                                                <tr>
...
<!--                                                                    <input type="text" value="${attmnt.name}" class="span10 make-enable" name="name" id="name" readonly/>-->
                                ...
                                <div class="row-fluid align-center">
                                    <button id="rfp_summary_details_close_btn_id" class="btn btn-inverse">Close</button>
                                </div>
