...
<body onload="supplierOnLoadFunction();
        onLoadFunction();">
                        ...
                        <div class="widget-main">
                            <div class="row-fluid">
                                ...
                                <div class="step-content row-fluid position-relative" id="step-container">
                                    <form class="form-vertical" id="validation-emp" method="post" action="doSubmitReleasedRfp.do" enctype="multipart/form-data">
                                        ...
                                        <div class="step-pane active" id="step1">
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <div class="">
                                                                <input value="${rfqDetails.supplierSelection.get(0).supplierWFstatus}" type="text" name="RFQSupplierStatus" id="RFQSupplierStatus" class="span10 form-field make-enable" required readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <div class="">
                                                                <input type="text" value="${username}" id="rfqstatus" name="rfqstatus" class="span10 form-field" required readonly/>
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Project Name/Number</label>
                                                        <div class="controls">
                                                            <div class="">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Open Date</label>
                                                        <div class="controls">
                                                            <div class="">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Close Date</label>
                                                        <div class="controls">
                                                            <div class="">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Bill to Address</label>
                                                        <div class="controls">
                                                            <div class="">
                                                ...
                                                <div class="span6">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Ship to Address</label>
                                                        <div class="controls">
                                                            <div class="">
                                            ...
                                            <div class="row-fluid">
                                                <div class="span6" id="costcodeReadonlyDiv">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Cost Code</label>
                                                        <div class="controls">
                                                            <div class="">
                                                ...
                                                <div class="span6" id="negotationstyleReadonlyDiv">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Negotiation Style</label>
                                                        <div class="controls">
                                                            <div class="">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <div class="span6 show-supplier-fields" style="display: none;" id="notetobuyerdiv">
                                                    <div class="control-group">
                                                        <label class="control-label" for="">Note to Buyer</label>
                                                        <div class="controls">
                                                            <div class="">
                                                                <!--<input type="text" value="" name="prd" id="prd" class="span10" required/>-->
                                                                <textarea style="" id="notetobuyer" name="notetobuyer" rows="4" class="span10"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row-fluid">
                                                <div class="span12">
                                                    <div style="overflow-x: auto;">
                                                        <table id="supplier_cat_subcat_table" name="supplier_cat_subcat_table" class="table table-striped table-bordered table-hover">
                                                            <thead>
                                                                <tr>
                                                                    <th>S.No.</th>
                                                                    <th>Category</th>
                                                                    ...
                                                                    <th>Target Price ( $ )</th>
                                                                    <th>Quantity</th>
                                                                    <th style="display: none;" class="show-supplier-fields">Price Per Quantity</th>
                                                                    <th style="display: none;" class="show-supplier-fields">Total Price</th>
                                                                    <th style="display: none;" class="show-supplier-fields">Expected Price</th>
                                                                    <th style="display: none;" class="show-supplier-fields">Expected Delivery Date</th>
                                                            ...
                                                            <tbody>
                                                                <c:forEach var="lineItem" items="${rfqDetails.rfqLineItems}" varStatus="status">
                                                                    <tr>
                                                                        ...
                                                                        <td style="display: none;" class="show-supplier-fields"><input type="number" class="form-field" style="width:120px;" id="price_per_quantity" name="price_per_quantity" required></td>
                                                                        <td style="display: none;" class="show-supplier-fields"><input type="number" style="width:120px;" id="total_price" name="total_price" readonly required></td>
                                                                        <td style="display: none;" class="show-supplier-fields"><input type="number" class="form-field" style="width:120px;" id="expected_price" name="expected_price"></td>
                                                                        <td style="display: none;" class="show-supplier-fields"><input type="date" class="form-field" style="width:130px;" id="expected_delv_date" name="expected_delv_date" required></td>
                                                ...
                                                <input type="hidden" name="noOfCategory" id="noOfCategory"/>
                                            </div>
                                        ...
                                        <div class="step-pane" id="step3">
                                            <div id="attDivId">
                                                <h4><b>Available Attachment</b></h4>
                                                <hr/>
...
<!--                                                                    <input type="text" value="${attmnt.name}" class="span10 make-enable" name="name" id="name" readonly/>-->
                                            ...
                                            <div id="supplierattachment" style="display: none;" class="show-supplier-fields">
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span10">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                <input type="file" id="supplier-input-file-1" class="span10" name="file"/>	
                                                ...
                                                <div class="row-fluid">
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            <label class="control-label" for="">Name</label>
                                                            <div class="controls">
                                                                <input type="text" class="span10" name="supplierAttName" id="supplierAttName"/>
                                                    ...
                                                    <div class="span6">
                                                        <div class="control-group">
                                                            ...
                                                            <div class="controls">
                                                                ...
                                                                <!--                                                                            <button type="button" id="add_att_btn" class="btn btn-small btn-info pull-right">Add</button>-->
                                                                <input type="button" value="Add" id="supplier_add_att_btn" class="btn btn-small btn-info pull-right"/>                        
                                                            </div>																
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="step-pane" id="step4">
                                            ...
                                            <div class="row-fluid">
                                                ...
                                                <input type="hidden" name="isAck" id="isAck" value="no"/>
                                ...
                                <div class="row-fluid wizard-actions">
                                    ...
                                    <button class="btn btn-info btn-next" data-last="Submit " id="next_btn">Next
                                ...
                                <div class="row-fluid align-center">
                                    <button id="reject_btn_id" class="btn btn-danger">Reject</button>
                                    <button id="acknowledge_btn_id" class="btn btn-purple">Accept</button>
                                    <button id="supplier_save_btn_id" class="btn btn-pink" style="display: none;">Save</button>
                                    <button id="supplier_close_btn_id" class="btn btn-inverse">Close</button>
                                </div>
                                <%
                                    }
                                %>
        ...
        $(function() {
            $('#fuelux-wizard').ace_wizard().on('change', function(e, info) {
                ...
                if (info.step === 1) {
                    ...
                    if ($("#isAck").val() === 'yes') {
                        var isValid = true;
                        $("#supplier_cat_subcat_table tr").each(function() {
                            var tr = $(this);
                            var price_per_q = tr.children('td:eq(6)').children('input').val();
                            var exp_price = tr.children('td:eq(8)').children('input').val();
                            var exp_date = tr.children('td:eq(9)').children('input').val();
                            if (price_per_q !== undefined && exp_price !== undefined && exp_price !== undefined)
                            {
//                        alert(price_per_q + " : " + exp_price + " : " + exp_date);

                                if (price_per_q === '')
                                {
                                    tr.children('td:eq(6)').children('input').css({"border-color": "red"});
                                    isValid = false;
                                }
                                if (exp_price === '')
                                {
                                    tr.children('td:eq(8)').children('input').css({"border-color": "red"});
                                    isValid = false;
                                }
                                if (exp_date === '')
                                {
                                    tr.children('td:eq(9)').children('input').css({"border-color": "red"});
                                    isValid = false;
                                }
                            }
                        });
                ...
                if ($("#RFQSupplierStatus").val() !== "Awaiting Bid")
                {
                    location.href = "mytask.do";
                    
                }
                else if ($("#RFQSupplierStatus").val() === "Awaiting Bid")
                {
                    if ($("#isAck").val() === "yes")
                    {
...
//                location.href = "doSubmitReleasedRfp.do"
            //$("#validation-emp").submit();
        ...
        $('#id-input-file-1 , #id-input-file-2, #supplier-input-file-1').ace_file_input({
            no_file: 'No File ...',
            btn_choose: 'Choose',
            btn_change: 'Change',
            droppable: false,
