...
public class CustomerNotificationDao {
    ...
    public List<?> findByCustomerUserIdAndNoUpdateProfile(int id)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("CustomerNotification.findByCustomerUserIdAndNoUpdateProfile", "id", id);
        return list;
    }
    public List<?> findUnreadMessages(String readstatus)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("CustomerNotification.findByStatus", "readstatus", readstatus);
        return list;
    }
    public List<?> findUnreadMessagesByCustomerIdAndReadStatus(int id)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("CustomerNotification.findByStatusAndCustomerId", "id", id);
        return list;
    }
    public List<?> findByNotificationId(int id)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("CustomerNotification.findById", "id", id);
        return list;
    }
}
