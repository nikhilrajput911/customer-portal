...
public class SupplierGroupDao {
    ...
    public List<?> findBySupplierGroupname(String groupname)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("SupplierGroup.findBySgroupname", "sgroupname", groupname);
        return list;
    }
    public List<?> findByGroupNameAndCustomerSubUserId(String groupName, int id)
    {
        String[] params =  new String[2];
        params[0] = "groupName";
        params[1] = "id";
        ...
        List<?> list = this.template.findByNamedQueryAndNamedParam("SupplierGroup.findByGroupNameAndCustomerSubUserId", params, values);
        return list;
    }
    public List<?> findByCustomerSubUserId(int id)
    {
        List<?> list = this.template.findByNamedQueryAndNamedParam("SupplierGroup.findByCustomerSubUserId", "id", id);
        return list;
    }
}
