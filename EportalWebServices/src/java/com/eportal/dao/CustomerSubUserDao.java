...
public class CustomerSubUserDao {
    ...
    public List<?> findByUsernameCheckAsActive(String username) {
        List<?> list = this.template.findByNamedQueryAndNamedParam("CustomerSubUser.findByUsernameAsActive", "username", username);
        return list;
    }
...
//                                                    .add(Restrictions.ne("status", "Delete")));
    ...
    public List<?> findByCustomerSeededId(int id)
    {
        List<?> customer = this.template.findByNamedQueryAndNamedParam("CustomerSubUser.findByCustomerSeededId", "cid", id);
        return customer;
    }
    public List<?> findByCustomerSeededIdForAutoMail(int id)
    {
        List<?> customer = this.template.findByNamedQueryAndNamedParam("CustomerSubUser.findByCustomerSeededIdForAutoMail", "cid", id);
        return customer;
    }
}
