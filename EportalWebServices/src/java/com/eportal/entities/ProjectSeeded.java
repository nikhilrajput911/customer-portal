...
@NamedQueries({
    ...
    @NamedQuery(name = "ProjectSeeded.findByCustomerId", query = "SELECT p FROM ProjectSeeded p WHERE p.bpaasCustomerseededCid.cid = :cid and p.projectstatus = 'Active' order by p.projectname asc"),
