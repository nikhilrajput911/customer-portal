...
@NamedQueries({
    ...
    @NamedQuery(name = "CustomerProjectMapping.findByCustomerUserId", query = "SELECT c FROM CustomerProjectMapping c where c.bpaasCustomersubuserId.id = :customerUserId and c.bpaasProjectseededPid.projectstatus = 'Active'"),
    @NamedQuery(name = "CustomerProjectMapping.findByCustomerUserIdAndProjectId", query = "SELECT c FROM CustomerProjectMapping c WHERE c.bpaasCustomersubuserId.id = :id and c.bpaasProjectseededPid.pid = :pid")})
