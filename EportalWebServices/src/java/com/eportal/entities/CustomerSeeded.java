...
@NamedQueries({
    ...
    @NamedQuery(name = "CustomerSeeded.findByAccountGroupType", query = "SELECT c FROM CustomerSeeded c WHERE c.accountGroupType = :accountGroupType order by c.customername asc"),
